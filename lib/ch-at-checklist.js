...
const CH_AT_CHECKLIST_ITEMS = [
  {
    ...
    category: 'Verpackung',
    // Pack2EU führt die Registrierung selbst NICHT durch - das übernimmt
    // der Bevollmächtigte, sobald die Vollmacht (siehe nächster Punkt)
    // unterschrieben und notariell beglaubigt ist. Ursprünglich fälschlich
    // als owner:'pack2eu' markiert (klang nach direkter Pack2EU-Leistung) -
    // auf Kundenhinweis korrigiert.
    owner: 'merchant',
    text: 'Registrierung im österreichischen Verpackungsregister (EDM) + Lizenzierung bei einem Sammel-/Verwertungssystem (z. B. ARA) - das übernimmt dein Bevollmächtigter für dich, sobald die Vollmacht (siehe nächster Punkt) unterschrieben und notariell beglaubigt ist. Pack2EU selbst führt die Registrierung nicht durch, vermittelt aber den Kontakt zum Bevollmächtigten.',
    source: 'EDM-Portal / ARA',
    links: [
      { label: 'EDM-Portal', url: 'https://edm.gv.at/' },
  ...
  },
  {
    ...
    links: [
      { label: 'notarity.com', url: 'https://notarity.com/en/' }
    ]
  },
  {
