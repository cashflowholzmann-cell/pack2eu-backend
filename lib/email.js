...
const COMP_ACCESS_NEW_ACCOUNT_TEXT = {
  de: {
    ...
    validity: 'Der Link ist 24 Stunden gültig. Schaut euch gerne alles in Ruhe an - über Feedback und Verbesserungsvorschläge freuen wir uns jederzeit.',
  ...
  en: {
    ...
    validity: 'The link is valid for 24 hours. Take your time exploring - we\'d love to hear any feedback or suggestions.',
  ...
  fr: {
    ...
    validity: 'Le lien est valable 24 heures. Prends le temps de tout découvrir - tes retours et suggestions sont toujours les bienvenus.',
  ...
  it: {
    ...
    validity: 'Il link è valido per 24 ore. Prenditi il tempo per esplorare tutto - siamo sempre felici di ricevere feedback e suggerimenti.',
  ...
  es: {
    ...
    validity: 'El enlace es válido durante 24 horas. Tómate tu tiempo para explorarlo todo - siempre agradecemos comentarios y sugerencias.',
